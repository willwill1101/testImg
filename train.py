...
sample,viz=hog(image, orientations=9, pixels_per_cell=pixpcell, cells_per_block=(2, 2), visualise=True)
...
for s in positives:
    if(s[-3:]=='png'):
        ...
        features[i]=hog(image, orientations=9, pixels_per_cell=pixpcell, cells_per_block=(2, 2), visualise=False)
        labels[i]=1
        i=i+1
